...
export default function Header() {
  ...
  return (
    <header className="bg-gradient-to-b from-[#f94c43] to-[#fd6d30] sticky top-0 z-50 ">
      {/* Top bar */}
      <div className=" text-white text-sm px-6 py-2  flex justify-between ml-3 mr-3">
        {/* Left */}
        <div className="flex items-center ml-5 ">
          <a href="#" className="hover:opacity-60">
            Seller Channel
          </a>
          <div className=" bg-white block w-[1.5px] h-4 mx-2 opacity-40  "></div>
          <a href="#" className="hover:opacity-60">
            Become a Shoppe Seller
          </a>
          <div className=" bg-white block w-[1.5px] h-4 mx-2 opacity-40  "></div>
        ...
        <div className="flex items-center justify-end gap-5 text-white text-sm">
          ...
          <span className="cursor-pointer hover:opacity-70">Register</span>

          <div className="w-px h-4 bg-white opacity-50"></div>

          <span className="cursor-pointer hover:opacity-70">Log in</span>
        </div>
      </div>
      {/* Bottom bar */}
      <div className="flex h-[88px] items-center ml-3 mr-3  ">
        ...
        <div className="flex flex-1 bg-white rounded-md overflow-hidden shadow-sm h-[44px] ml-14 mr-14">
          <input
            ...
            className="flex-1 px-6 text-sm text-gray-700 outline-none cursor-text"
          />
          <button className="bg-[#fb5533] px-6 flex items-center justify-center text-white hover:opacity-90 h-9 mr-1 mt-1 rounded-md">
